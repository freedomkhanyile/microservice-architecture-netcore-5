...
namespace Account.Microservice.Application.Events
{
    public class AccountCreatedEvent : Event
    {
        ...
        public AccountCreatedEvent(int accountId, string firstName, string lastName, string cellphone, string email, bool isThirdParty, string thirdPartyProvider)
        {
            AccountId = accountId;
            FirstName = firstName;
            LastName = lastName;
